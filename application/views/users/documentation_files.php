...
<?php
    $allowed_roles = ['Document Controller', 'Director for QAIE', 'QAIE Management Officer'];
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <center><h3 class="text-danger">Are you sure you want to delete this File?</h3></center>
                                        </div>
                                    </div>
                                </div>
