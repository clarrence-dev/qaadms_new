<div id="page-inner" class="profile">
    ...
    <?php else: ?>
        <img src="<?= base_url('profile_settings/profile_image/' . $user['user_id'] . '/' . $user['my_img']) ?>" class="user-image img-responsive" style="margin:10px auto; border:2px solid #ccc8c8; border-radius:10px;"/>
    <?php endif; ?>
        <br>
