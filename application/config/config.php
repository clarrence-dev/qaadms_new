...
|
*/
$config['base_url'] = 'http://localhost/qaadms_new/';  // Adjust this to match your setup
...
|
*/
$config['log_threshold'] = 1; // Only ERROR messages
$config['log_threshold'] = 2; // DEBUG messages and higher
$config['log_threshold'] = 3; // INFO messages and higher
$config['log_threshold'] = 4; // All messages (including custom messages)
