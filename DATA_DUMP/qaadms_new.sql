...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 21, 2024 at 04:28 AM
...
-- Database: `qaadms_new`
--
CREATE DATABASE IF NOT EXISTS `qaadms_new` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `qaadms_new`;
...
--
-- Truncate table before insert `all_users`
--
...
(108, 'Elon', 'Musk', 'superadmin', 'b9eb282b55e17784c39aed41e77a3f96', 'No Department', 'No Office', '', 'superadmin@gmail.com', NULL, 'Super Admin', '5701d51baafb4b5b62deee43df9e1358.PNG', '0', '', '', '2024-05-31 21:47:40.840281'),
...
(218, 'Steve', 'Rogers', 'requester', '1a1dc91c907325c69271ddf0c944bc72', 'Academics', 'SBCS', 'ENABLED', 'requester@gmail.com', NULL, 'Requester', 'd7a834a8abad3a83ecc2b458aabe6b15.PNG', NULL, 'fab72a8af49b889f9e02b7cf1d58b234', 'VERIFIED', '2024-05-31 21:49:49.381224'),
(220, 'Donald', 'Trump', 'president', '3c83d93b27f9f9623329343f83dba186', 'Academics', 'SBCS', 'ENABLED', 'president@gmail.com', NULL, 'President', '121df3103833eec63cf18d5f393fe4a2.PNG', NULL, 'e6c8f28627b4a810dec6687369e74043', 'VERIFIED', '2024-05-31 22:03:01.829681'),
(221, 'James', 'Cameron', 'directorforqaie', 'a9612e454b547757e2f06160db0b3589', 'Academics', 'SBCS', 'ENABLED', 'directorforqaie@gmail.com', '2379e15867f17cc612c1b52a733f2de9.PNG', 'Director for QAIE', 'e4213749fc05120692f7133aef5aac35.PNG', NULL, 'fb1dec807baffe24f7d3faed0c1fce94', 'VERIFIED', '2024-05-31 21:55:27.248505'),
(222, 'Peter', 'Parker', 'qaiemgmtofficer', '56f3b310cf563d5465d1b634ccae982f', 'Academics', 'SBCS', 'ENABLED', 'qaiemgmtofficer@gmail.com', NULL, 'QAIE Management Officer', 'a2867b7c8af46596fec5e7c145943dfc.PNG', NULL, 'f288539cca98a8484851c753e2b27409', 'VERIFIED', '2024-05-31 21:57:40.598509'),
(223, 'Simon', 'Cowell', 'departmenthead', '5db35d08772400e34f82b9da8fb89615', 'Academics', 'SBCS', 'ENABLED', 'departmenthead@gmail.com', 'bb132b9eef46797a4af8a7d875c29295.PNG', 'Department Head', '26be45b563a87652fbcb78769c5610c8.PNG', NULL, '7539b9f20395c656aeaf694f6d8566b0', 'VERIFIED', '2024-05-31 21:52:25.381402'),
(224, 'Harry', 'Potter', 'documentcontroller', '96ac8ddee9c00dd7086f10aa9b431e1f', 'Academics', 'SBCS', 'ENABLED', 'documentcontroller@gmail.com', NULL, 'Document Controller', 'c558ce22fc359553e59dc747130ffb03.PNG', NULL, '8ec96e046051e90a23292fe75b40223d', 'VERIFIED', '2024-05-31 21:59:51.810216'),
(227, 'JOHN', 'Doe', 'johny', 'c6cde9d631ed0bfaa9bdd426d09b7956', 'No department', 'SBCS', '', 'juan.doe@gmail.com', NULL, 'Document Controller', NULL, NULL, '', '', '2024-09-16 13:40:31.847849');
...
DROP TABLE IF EXISTS `auditee_afsform`;
...
--
-- Truncate table before insert `auditee_afsform`
--

TRUNCATE TABLE `auditee_afsform`;
--
...
DROP TABLE IF EXISTS `auditee_afsform_2_desc`;
...
--
-- Truncate table before insert `auditee_afsform_2_desc`
--

TRUNCATE TABLE `auditee_afsform_2_desc`;
--
...
DROP TABLE IF EXISTS `auditee_afsform_desc`;
...
--
-- Truncate table before insert `auditee_afsform_desc`
--

TRUNCATE TABLE `auditee_afsform_desc`;
--
...
DROP TABLE IF EXISTS `emanual_types`;
...
--
-- Truncate table before insert `emanual_types`
--

TRUNCATE TABLE `emanual_types`;
--
...
--
-- Truncate table before insert `event_types`
--
...
--
-- Truncate table before insert `folder_access`
--

TRUNCATE TABLE `folder_access`;
--
...
DROP TABLE IF EXISTS `folder_offices`;
...
--
-- Truncate table before insert `folder_offices`
--

TRUNCATE TABLE `folder_offices`;
-- --------------------------------------------------------
...
DROP TABLE IF EXISTS `home_nea_datatable`;
...
--
-- Truncate table before insert `home_nea_datatable`
--

TRUNCATE TABLE `home_nea_datatable`;
--
...
DROP TABLE IF EXISTS `qaiedirector_dcrform`;
...
--
-- Truncate table before insert `qaiedirector_dcrform`
--

TRUNCATE TABLE `qaiedirector_dcrform`;
--
-- Dumping data for table `qaiedirector_dcrform`
--

INSERT INTO `qaiedirector_dcrform` (`Year_Generated`, `DCRForm_ID`, `Status_DocuController`, `Status_DeptHead`, `Status_Requester`, `QAIE_Directors_Comments`, `Request_Status`, `ESignature_DoQ`, `Name_Of_QAIE_Director`, `Date_Of_QAIE_Director_Action`, `ESignature_DeptHead`, `Name_Of_Approving_Authority`, `Date_Of_Approval`, `Date_Of_Request`, `To_Who`, `From_Office`, `Type_Of_Request`, `Document_No`, `Document_Title`, `Revision_Status`, `Changes_Requested`, `Reason_For_The_Change`, `Requested_By`, `New_Document_No`, `New_Document_Version`, `New_Document_Revision`, `date_uploaded_dttbl`, `Random_Unique_Code`, `User_ID`) VALUES
(2024, 000, NULL, NULL, 'Already Sent to Department Head', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '09/19/2024', 'Document Controller', 'SBCS', 'New Document', 'asasas', '1121', 'asas', 'asasasas', 'qwqqwqw', 'requester', '1212', '12121212', '1222222222222222222', '2024-09-19 15:42:01', 'ab2d293510ae2816026e65fb5093805c', 218);
...
DROP TABLE IF EXISTS `qaiedirector_dcrform_desc`;
...
--
-- Truncate table before insert `qaiedirector_dcrform_desc`
--

TRUNCATE TABLE `qaiedirector_dcrform_desc`;
--
...
(0, 'ab2d293510ae2816026e65fb5093805c', 'GbzFYvsVm9cEinu.pdf', 'application/pdf', '2024-09-19 15:42:01', 218),
...
DROP TABLE IF EXISTS `storage_asr`;
...
--
-- Truncate table before insert `storage_asr`
--

TRUNCATE TABLE `storage_asr`;
--
...
DROP TABLE IF EXISTS `storage_documentations`;
...
--
-- Truncate table before insert `storage_documentations`
--

TRUNCATE TABLE `storage_documentations`;
--
...
(2, 'TEST', 'xWMXoduBlzPUSiZ.pdf', 'application/pdf', '2024-09-21 03:21:00', 227, 1);
...
DROP TABLE IF EXISTS `storage_emanuals`;
...
--
-- Truncate table before insert `storage_emanuals`
--

TRUNCATE TABLE `storage_emanuals`;
--
...
(0, '234525235345', 'xWMXoduBlzPUSiZ1.pdf', 'application/pdf', '2024-09-21 03:57:30', 'Master Copy Version', 227),
...
(49, 'TEst', '631754f6e79503_67223007.pdf', 'application/pdf', '2024-09-16 16:43:56', 'Master Copy Version', 227);
...
--
-- Truncate table before insert `whoweare`
--

TRUNCATE TABLE `whoweare`;
--
...
DROP TABLE IF EXISTS `whoweare_new`;
...
--
-- Truncate table before insert `whoweare_new`
--

TRUNCATE TABLE `whoweare_new`;
--
...
DROP TABLE IF EXISTS `x_auditors`;
...
--
-- Truncate table before insert `x_auditors`
--

TRUNCATE TABLE `x_auditors`;
--
...
DROP TABLE IF EXISTS `y1_user_logs`;
...
--
-- Truncate table before insert `y1_user_logs`
--

TRUNCATE TABLE `y1_user_logs`;
--
...
DROP TABLE IF EXISTS `y2_auditcalendarevents_logs`;
...
--
-- Truncate table before insert `y2_auditcalendarevents_logs`
--

TRUNCATE TABLE `y2_auditcalendarevents_logs`;
--
...
DROP TABLE IF EXISTS `y2_auditcalendarevents_logs_new`;
...
--
-- Truncate table before insert `y2_auditcalendarevents_logs_new`
--

TRUNCATE TABLE `y2_auditcalendarevents_logs_new`;
-- --------------------------------------------------------
...
DROP TABLE IF EXISTS `y3_auditcalendareventtypes_logs`;
...
--
-- Truncate table before insert `y3_auditcalendareventtypes_logs`
--

TRUNCATE TABLE `y3_auditcalendareventtypes_logs`;
--
...
DROP TABLE IF EXISTS `y3_auditcalendareventtypes_logs_new`;
...
--
-- Truncate table before insert `y3_auditcalendareventtypes_logs_new`
--

TRUNCATE TABLE `y3_auditcalendareventtypes_logs_new`;
-- --------------------------------------------------------
...
DROP TABLE IF EXISTS `y4_nea_logs`;
...
--
-- Truncate table before insert `y4_nea_logs`
--

TRUNCATE TABLE `y4_nea_logs`;
--
...
DROP TABLE IF EXISTS `y4_nea_logs_new`;
...
--
-- Truncate table before insert `y4_nea_logs_new`
--

TRUNCATE TABLE `y4_nea_logs_new`;
-- --------------------------------------------------------
...
DROP TABLE IF EXISTS `y5_afsforms_logs`;
...
--
-- Truncate table before insert `y5_afsforms_logs`
--

TRUNCATE TABLE `y5_afsforms_logs`;
-- --------------------------------------------------------
...
DROP TABLE IF EXISTS `y6_dcrforms_logs`;
...
--
-- Truncate table before insert `y6_dcrforms_logs`
--

TRUNCATE TABLE `y6_dcrforms_logs`;
--
...
(0, '', 'Submitted Document Change Request Form', 'requester', 'Requester'),
...
DROP TABLE IF EXISTS `y7_asr_logs`;
...
--
-- Truncate table before insert `y7_asr_logs`
--

TRUNCATE TABLE `y7_asr_logs`;
--
...
DROP TABLE IF EXISTS `y8_emanuals_logs`;
...
--
-- Truncate table before insert `y8_emanuals_logs`
--

TRUNCATE TABLE `y8_emanuals_logs`;
--
...
--
-- Truncate table before insert `z_department`
--

TRUNCATE TABLE `z_department`;
--
...
--
-- Truncate table before insert `z_office`
--

TRUNCATE TABLE `z_office`;
--
